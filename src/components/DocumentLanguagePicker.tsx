...
import type { AvailableHausordnungLanguage } from "@/lib/content/hausordnung";
 ...
 * placements the page needs (CLAUDE.md: /moschee/hausordnung — "One
 * component used in both placements, with a `placement` prop — not two
 * components"): `standalone` is the centered chooser shown with no
 * document selected; `top` sits above the rendered document so the reader
 * can switch language without leaving the page.
 */
export function DocumentLanguagePicker({
  ...
  languages: AvailableHausordnungLanguage[];
    ...
    <div
      className={
        isStandalone
          ...
          : "flex flex-wrap items-center gap-3 border-b border-secondary/45 px-4 py-4 md:px-10 print:hidden"
      }
    >
